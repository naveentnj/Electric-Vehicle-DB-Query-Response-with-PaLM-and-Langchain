...
def get_few_shot_db_chain():
    ...
    mysql_prompt = """You are a Microsoft SQL Server expert. Given an input question, first create a syntactically correct Microsoft SQL Server query to run, then look at the results of the query and return the answer to the input question.
